...
function addPrimGrau(){
	...
	var FuncaoJqueryAdd = $(document.createElement("div")).attr("class","input-group").attr("id", "inputGroup1Grau-"+numApoios1Grau).appendTo("#divApoios");
								$(document.createElement("div")).attr("class","input-group-addon").attr("id", "inputGroupAdd1Grau-"+numApoios1Grau).appendTo("#inputGroup1Grau-"+numApoios1Grau);
									$(document.createElement("img")).attr("width","47").attr("height","19").attr("alt","...").attr("src","http://rawgit.com/luanh-s/VigaElemFinitos/master/Img/rolete.png").attr("id","Foto1Grau-"+numApoios1Grau).appendTo("#inputGroupAdd1Grau-"+numApoios1Grau);
...
function addSeguGrau(){
	...
	var FuncaoJqueryAdd = $(document.createElement("div")).attr("class","input-group").attr("id", "inputGroup2Grau-"+numApoios2Grau).appendTo("#divApoios");
								$(document.createElement("div")).attr("class","input-group-addon").attr("id", "inputGroupAdd2Grau-"+numApoios2Grau).appendTo("#inputGroup2Grau-"+numApoios2Grau);
									$(document.createElement("img")).attr("width","47").attr("height","19").attr("alt","...").attr("src","http://rawgit.com/luanh-s/VigaElemFinitos/master/Img/apoio 2.png").attr("id","Foto2Grau-"+numApoios2Grau).appendTo("#inputGroupAdd2Grau-"+numApoios2Grau);
		...
		numApoios++;
			...
			var FuncaoJqueryAdd = $(document.createElement("div")).attr("class","input-group").attr("id", "inputGroup3Grau-"+numApoios3Grau).appendTo("#divApoios");
										$(document.createElement("div")).attr("class","input-group-addon").attr("id", "inputGroupAdd3Grau-"+numApoios3Grau).appendTo("#inputGroup3Grau-"+numApoios3Grau);
											$(document.createElement("img")).attr("width","47").attr("height","19").attr("alt","...").attr("src","http://rawgit.com/luanh-s/VigaElemFinitos/master/Img/engasteIconeSmall.png").attr("id","Foto3Grau-"+numApoios3Grau).appendTo("#inputGroupAdd3Grau-"+numApoios3Grau);
...
function addForca(){
	...
	var FuncaoJqueryAdd = $(document.createElement("div")).attr("class","input-group").attr("id", "inputGroupForca-"+numForcasAplic).appendTo("#divCargas");
								 $(document.createElement("div")).attr("class","input-group-addon").attr("id", "inputGroupAddForca-"+numForcasAplic).appendTo("#inputGroupForca-"+numForcasAplic);
									 $(document.createElement("img")).attr("width","47").attr("height","47").attr("alt","...").attr("src","http://rawgit.com/luanh-s/VigaElemFinitos/master/Img/PIcone.png").attr("id","FotoForca-"+numForcasAplic).appendTo("#inputGroupAddForca-"+numForcasAplic);
...
function addCarreg(){
	...
	var FuncaoJqueryAdd = $(document.createElement("div")).attr("class","input-group").attr("id", "inputGroupCarreg-"+numCarregAplic).appendTo("#divCargas");
								$(document.createElement("div")).attr("class","input-group-addon").attr("id", "inputGroupAddCarreg-"+numCarregAplic).appendTo("#inputGroupCarreg-"+numCarregAplic);
									$(document.createElement("img")).attr("width","47").attr("height","47").attr("alt","...").attr("src","http://rawgit.com/luanh-s/VigaElemFinitos/master/Img/carregamentoIcone.png").attr("id","FotoCarreg-"+numCarregAplic).appendTo("#inputGroupAddCarreg-"+numCarregAplic);
...
function addMoment(){
	...
	var FuncaoJqueryAdd = $(document.createElement("div")).attr("class","input-group").attr("id", "inputGroupMoment-"+numMomentAplic).appendTo("#divCargas");
								$(document.createElement("div")).attr("class","input-group-addon").attr("id", "inputGroupAddMoment-"+numMomentAplic).appendTo("#inputGroupMoment-"+numMomentAplic);
									$(document.createElement("img")).attr("width","47").attr("height","47").attr("alt","...").attr("src","http://rawgit.com/luanh-s/VigaElemFinitos/master/Img/momento SH Icone.png").attr("id","FotoMoment-"+numMomentAplic).appendTo("#inputGroupAddMoment-"+numMomentAplic);
...
function canvasincial() {
  fabric.Image.fromURL('C:/Users/Spencer/Desktop/Datas/PROJETO TCC/viga I.png', function(oImg) {
...
function DesenhaProblemaProposto (){
    ...
    imgObj.src = 'C:/Users/Spencer/Desktop/Datas/PROJETO TCC/viga I.png';
    var imgObj2 = new Image();
    imgObj2.src = 'C:/Users/Spencer/Desktop/Datas/PROJETO TCC/P.png'
  ...
  function preencheArrayEDesenhaApoios(){
  	...
  	function adicionaEmLoopRolete(i){
  		...
  		fabric.Image.fromURL('C:/Users/Spencer/Desktop/Datas/PROJETO TCC/rolete.png', function(oImg1) {
  	...
  	function adicionaEmLoop2Grau(j){
  		...
  		fabric.Image.fromURL('C:/Users/Spencer/Desktop/Datas/PROJETO TCC/apoio 2.png', function(oImg2) {
  	...
  	function adicionaEmLoopEngaste(k){
  		...
  		if (Array3GrauPos[k] == 0) {
  			var url = 'C:/Users/Spencer/Desktop/Datas/PROJETO TCC/engaste E.png'
  		}
  		if (Array3GrauPos[k] == tamvig) {
  			var url = 'C:/Users/Spencer/Desktop/Datas/PROJETO TCC/engaste D.png'
  		}
  ...
  function preencheArrayEDesenhaForcas(){
  	...
  	function adicionaEmLoopForca(i){
  		...
  		fabric.Image.fromURL('C:/Users/Spencer/Desktop/Datas/PROJETO TCC/P.png', function(oImg4) {
  	...
  	function adicionaEmLoopCarreg(j){
        ...
        canvas.add(line3);
  		...
  		function LoopInterno(m) {
  			fabric.Image.fromURL('C:/Users/Spencer/Desktop/Datas/PROJETO TCC/PCarr.png', function(oImg4) {
  			oImg4.scale(widthcanvas*0.0007);
  	...
  	function adicionaEmLoopMomento(k){
  		...
  		fabric.Image.fromURL('C:/Users/Spencer/Desktop/Datas/PROJETO TCC/momento SH canvas.png', function(oImg6) {
